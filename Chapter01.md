...
🖼️ [IMAGE PLACEHOLDER: Screenshot of the BlueJ main window showing the tan boxes for Circle, Square, and Triangle]
Caption: The tan boxes are Classes. Notice the arrows showing how they connect to the Canvas.
...
🖼️ [IMAGE PLACEHOLDER: Screenshot of the BlueJ Object Bench at the bottom of the screen with a few red shape objects sitting on it]
Caption: The red boxes are Objects. They have been built from the blueprints and exist in the computer's memory.

🏃‍♂️ State and Behavior
...
🖼️ [IMAGE PLACEHOLDER: Screenshot of the BlueJ "Object Inspector" window showing variables like xPosition = 50, color = "red"]
Caption: The Object Inspector reveals the hidden variables (State) stored inside the object.
